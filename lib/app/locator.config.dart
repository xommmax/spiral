...
import 'package:floor/floor.dart' as _i16;
...
import '../data/api/repository/publication_remote_repository.dart' as _i19;
import '../data/api/repository/support_remote_repository.dart' as _i22;
import '../data/api/repository/user_remote_repository.dart' as _i26;
import '../data/db/dairo_database.dart' as _i7;
import '../data/db/repository/hub_local_repository.dart' as _i12;
import '../data/db/repository/publication_local_repository.dart' as _i18;
import '../data/db/repository/user_local_repository.dart' as _i25;
import '../di/database_module.dart' as _i29;
import '../di/navigation_module.dart' as _i30;
...
import '../domain/repository/publication/impl/publication_repository_impl.dart'
    as _i21;
import '../domain/repository/publication/publication_repository.dart' as _i20;
import '../domain/repository/support/impl/support_repository_impl.dart' as _i24;
import '../domain/repository/support/support_repository.dart' as _i23;
import '../domain/repository/user/impl/user_repository_impl.dart' as _i28;
import '../domain/repository/user/user_repository.dart' as _i27;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i16.Migration>(() => databaseModule.migration1to2);
  gh.lazySingleton<_i17.NavigationService>(
      () => navigationModule.navigationService);
  gh.lazySingleton<_i18.PublicationLocalRepository>(
      () => _i18.PublicationLocalRepository());
  gh.lazySingleton<_i19.PublicationRemoteRepository>(
      () => _i19.PublicationRemoteRepository());
  gh.lazySingleton<_i20.PublicationRepository>(
      () => _i21.PublicationRepositoryImpl());
  gh.lazySingleton<_i22.SupportRemoteRepository>(
      () => _i22.SupportRemoteRepository());
  gh.lazySingleton<_i23.SupportRepository>(() => _i24.SupportRepositoryImpl());
  gh.lazySingleton<_i25.UserLocalRepository>(() => _i25.UserLocalRepository());
  gh.lazySingleton<_i26.UserRemoteRepository>(
      () => _i26.UserRemoteRepository());
...
class _$NavigationModule extends _i30.NavigationModule {
  @override
  _i17.NavigationService get navigationService => _i17.NavigationService();
}
